...
//#include "Util.h"can cause all kinds undefined related to file operation and freeimage!!!
...
{
	m_data.free();
	//m_rayIntervalSplatting.OnD3D11DestroyDevice();change by guan
}
...
//	m_data.d_rayIntervalSplatMaxArray = m_rayIntervalSplatting.mapMaxToCuda();//change by guan
	...
	//m_rayIntervalSplatting.unmapCuda();// change by guan
...
/*
void CUDARayCastSDF::rayIntervalSplatting(const HashDataStruct& hashData, const HashParams& hashParams, const mat4f& lastRigidTransform)//change by guan
{
